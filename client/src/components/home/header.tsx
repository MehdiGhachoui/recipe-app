...
export default function Header({ setInput }: HeaderProps) {
    ...
    return (
        <div className=" grid md:grid-cols-3 gap-3 grid-cols-1 border-b-solid border-b-[1px] border-b-orange-300 w-full min-h-[80px] mt-2 py-5">
            <h2 className="text-4xl text-orange-500 text-center md:text-left">Recipe</h2>
